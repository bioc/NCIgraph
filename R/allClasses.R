...
setClass('NCIgraph',contains='graphNEL')

setMethod('subGraph', signature('character','NCIgraph'), function(snodes,graph) {g <- callNextMethod(snodes,graph); class(g) <- 'NCIgraph'; return(g)})
